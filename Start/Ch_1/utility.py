...
quakefelt = any(quake["properties"]["felt"] != None and quake["properties"]["felt"] > 25000 for quake in data["features"])
print(quakefelt)
# TODO: how many quakes were felt by more than 500 people?
quakefelt_500 = sum(quake["properties"]["felt"] != None and quake["properties"]["felt"] > 500 for quake in data["features"])
print(quakefelt_500)

# TODO: how many quakes had a magnitude of 6 or larger?

quakemag_6 = sum(quake["properties"]["mag"] != None
